...
def transformDOTA2YOLO(class_filepath, input_images_dir, input_gt_dir, output_images_dir, output_gt_dir):
...
if __name__ == '__main__':
    ...
    if oper_type == 1:
        ...
        output_images_dir, output_gt_dir = sys.argv[5], sys.argv[6]
        transformDOTA2YOLO(class_filepath, input_images_dir, input_gt_dir, output_images_dir, output_gt_dir)
    elif oper_type == 2:
